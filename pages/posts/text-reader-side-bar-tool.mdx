---
title: TextReaderSideBarTool
date: 2022/09/07
description: A IntelliJ Platform Plugin.
tag: Development
author: MUEDSA
---
...
<NextSeo title="TextReaderSideBarTool"/>
...
**按行读取**
- 每行字数：设置按行读取的每行字数
- 展示方式：按行读取的内容展示在哪里 *支持展示在通知、状态栏、编辑器背景（新UI由于有新时间线通知管理的工具窗口，已不会展示在状态栏左侧）*
